...
@endsection
	@section('content')
		...
		<div class="slider-item" style="background-image: url(storage/silder_images/{{$slider->slider_image}});">
						...
						<div class="text py-3 pb-4 px-3 text-center">
							...
							<div class="bottom-area d-flex px-3">
								<div class="m-auto d-flex">
									...
									<a href="{{url('/addtocard/'.$product->id)}}" class="buy-now d-flex justify-content-center align-items-center mx-1">
