        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-warning">
              ...
              {!!Form::open(['url'=> url('/updateslider'),'method' =>'POST','enctype'=>'multipart/form-data'])!!} 
                    <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    {{Form::text('description1',$slider->description1,['class'=>'form-control','id'=>'exampleInputEmail1','placeholder'=>'descripcion1'])}}
                  </div>

                  <div class="form-group">
                   
                    {{Form::label('','Description two',['for'=>'exampleInputEmail1'])}}
                    {{Form::text('description2',$slider->description2,['class'=>'form-control','id'=>'exampleInputEmail1','placeholder'=>'descripcion2'])}}
                  </div>
